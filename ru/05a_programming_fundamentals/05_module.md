...
ту же проблему, что и в [абзаце выше](#файлы-реализации-cpp).
...
Несколько *одинаковых* объявлений одной функции допустимы, ошибки не будет.
...
Само по себе циклическое включение не запрещено: препроцессор просто раскрывает файлы последовательно.

...
- Вы создали branch для фичи1, на основе основной ветки. Поработали над ней. 
  ...
  Сделали PR и влили фича1 в основную ветку. Притянули основную ветку локально через `git pull`.
  Как теперь правильно влить фича2 в основную ветку?
> <details>
> <summary>Ответ</summary>
> Вы можете открыть PR напрямую из фича2 в основную ветку. Если конфликтов нет, PR сработает.
>

...
Без инициализации `auto` не работает: `auto a;` не скомпилируется,
потому что нет выражения, из которого можно вывести тип.
...
### 10. `auto` с универсальной инициализацией
...
### 14. Побитовая операция (продвинутый уровень)
```cpp
#include <cstdint>
#include <iostream>
...
### 15. Смена знака (продвинутый уровень)
```cpp
#include <cstdint>
#include <iostream>
